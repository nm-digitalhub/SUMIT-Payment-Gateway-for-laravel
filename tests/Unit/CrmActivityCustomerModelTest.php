...
/**
 * Test CrmActivity customer model resolution.
 *
 ...
 */
class CrmActivityCustomerModelTest extends TestCase
{
    /**
    ...
    public function test_client_relationship_delegates_to_customer(): void
    {
        ...
        $clientRelationship = $activity->client();
