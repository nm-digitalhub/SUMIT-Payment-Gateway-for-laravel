...
/**
 * Test OfficeGuyTransaction customer model resolution.
 *
 * Tests the refactored customer/client relationships that use dynamic model resolution
 * via config('officeguy.models.customer') instead of hard-coded App\Models\Client.
 *
 * Tests cover:
 ...
 */
class OfficeGuyTransactionCustomerModelTest extends TestCase
{
    /**
    ...
    public function test_customer_relationship_uses_configured_model(): void
    {
        ...
        // Create a mock transaction (not persisted)
    ...
    public function test_client_relationship_delegates_to_customer(): void
    {
        ...
        $customerRelationship = $transaction->customer();
        $clientRelationship = $transaction->client();
    ...
    public function test_client_relationship_backward_compatibility(): void
    {
        ...
        $relationship = $transaction->client();
    ...
    public function test_customer_and_client_relationships_are_identical(): void
    {
        ...
        // Act: Get both relationships
        $customerRel = $transaction->customer();
        $clientRel = $transaction->client();
