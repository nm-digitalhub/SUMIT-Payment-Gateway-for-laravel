...
<?php
        ...
        if (isset($GeneralFields['store_name'])) {
            $GeneralFields['officeguycompanyid'] = ['label' => __('SUMIT Company ID', 'wc-frontend-manager'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $CompanyID];
            $GeneralFields['officeguyapikey'] = ['label' => __('SUMIT API Key', 'wc-frontend-manager'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $APIKey];
        }
    ...
    public static function SaveOfficeGuyAPIFields($UserID, $WCFMSettingsForm)
    {
        ...
        $WCFMSettingsForm_data_storetype = [];
