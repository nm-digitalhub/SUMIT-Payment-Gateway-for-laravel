        ...
        <div class="max-w-6xl mx-auto">
                ...
                <ol class="flex items-center justify-center" role="list">
                    @if($rtl)
                        ...
                        <li class="flex flex-col items-center gap-2" aria-current="{{ $currentStep === 4 ? 'step' : 'false' }}">
                            <div class="size-11 sm:size-12 rounded-full border-2 {{ $currentStep >= 4 ? 'bg-[#3B82F6] border-[#3B82F6] text-white' : 'border-gray-300 text-gray-400' }} flex items-center justify-center transition-all duration-300">
                                <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                                </svg>
                            </div>
                            <span class="text-xs sm:text-sm {{ $currentStep >= 4 ? 'font-medium text-[#3B82F6]' : 'text-gray-400' }} transition-all duration-300">{{ __('Submit') }}</span>
                        </li>

                        <div class="w-8 sm:w-12 md:w-20 h-0.5 {{ $currentStep >= 4 ? 'bg-[#3B82F6]' : 'bg-gray-200' }} mx-1 sm:mx-2 transition-colors duration-200" aria-hidden="true"></div>

                        {{-- Step 3: תנאים --}}
                        <li class="flex flex-col items-center gap-2" aria-current="{{ $currentStep === 3 ? 'step' : 'false' }}">
                            <div class="size-11 sm:size-12 rounded-full {{ $currentStep >= 3 ? 'bg-[#3B82F6] text-white' : 'border-2 border-gray-300 text-gray-400' }} flex items-center justify-center text-sm font-medium transition-all duration-300">3</div>
                            <span class="text-xs sm:text-sm {{ $currentStep >= 3 ? 'font-medium text-[#3B82F6]' : 'text-gray-400' }} transition-all duration-300">{{ __('Terms') }}</span>
                        </li>

                        <div class="w-8 sm:w-12 md:w-20 h-0.5 {{ $currentStep >= 3 ? 'bg-[#3B82F6]' : 'bg-gray-200' }} mx-1 sm:mx-2 transition-colors duration-200" aria-hidden="true"></div>

                        {{-- Step 2: תשלום --}}
                        <li class="flex flex-col items-center gap-2" aria-current="{{ $currentStep === 2 ? 'step' : 'false' }}">
                            <div class="size-11 sm:size-12 rounded-full {{ $currentStep >= 2 ? 'bg-[#3B82F6] text-white' : 'border-2 border-gray-300 text-gray-400' }} flex items-center justify-center text-sm font-medium transition-all duration-300">2</div>
                            <span class="text-xs sm:text-sm {{ $currentStep >= 2 ? 'font-medium text-[#3B82F6]' : 'text-gray-400' }} transition-all duration-300">{{ __('Payment') }}</span>
                        </li>

                        <div class="w-8 sm:w-12 md:w-20 h-0.5 {{ $currentStep >= 2 ? 'bg-[#3B82F6]' : 'bg-gray-200' }} mx-1 sm:mx-2 transition-colors duration-200" aria-hidden="true"></div>

                        {{-- Step 1: פרטי לקוח (Active) --}}
                        <li class="flex flex-col items-center gap-2" aria-current="{{ $currentStep === 1 ? 'step' : 'false' }}">
                            <div class="size-11 sm:size-12 rounded-full {{ $currentStep >= 1 ? 'bg-[#3B82F6] text-white' : 'border-2 border-gray-300 text-gray-400' }} flex items-center justify-center text-sm font-medium transition-all duration-300">1</div>
                            <span class="text-xs sm:text-sm {{ $currentStep >= 1 ? 'font-medium text-[#3B82F6]' : 'text-gray-400' }} transition-all duration-300">{{ __('Customer') }}</span>
                        </li>
                    @else
                        {{-- LTR Order: 1 → 2 → 3 → 4 (left to right) --}}
                        <li class="flex flex-col items-center gap-2" aria-current="{{ $currentStep === 1 ? 'step' : 'false' }}">
                            <div class="size-11 sm:size-12 rounded-full bg-[#3B82F6] text-white flex items-center justify-center text-sm font-medium transition-all duration-300">1</div>
                            <span class="text-xs sm:text-sm font-medium text-[#3B82F6] transition-all duration-300">{{ __('Customer') }}</span>
                        </li>

                        <div class="w-8 sm:w-12 md:w-20 h-0.5 bg-[#3B82F6] mx-1 sm:mx-2 transition-all duration-300" aria-hidden="true"></div>
            ...
            <div class="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-6" role="list" aria-label="Security features">
                <div class="flex items-center gap-2 bg-white px-3 py-2 rounded-full shadow-sm hover:shadow-md transition-shadow duration-200" role="listitem">
                    <svg class="size-4 text-[#3B82F6] shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                ...
                <div class="flex items-center gap-2 bg-white px-3 py-2 rounded-full shadow-sm hover:shadow-md transition-shadow duration-200" role="listitem">
                    <svg class="size-4 text-[#3B82F6] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="text-center mb-8">
                {{-- Logo Section --}}
                <div class="mb-6">
                    <div class="inline-flex items-center justify-center gap-3 bg-white px-5 sm:px-6 py-3.5 sm:py-4 rounded-2xl shadow-sm">
                        {{-- Logo Icon - NM-DigitalHub Professional Logo (Responsive - Larger for Mobile) --}}
                        <div class="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#3B82F6] to-[#2563EB] rounded-xl shadow-lg shadow-blue-500/25">
                            <img src="{{ asset('images/logos/nm-logo-white-optimized.svg') }}"
                ...
                <div class="mb-4 inline-flex items-center gap-2 bg-gradient-to-r from-[#DBEAFE] to-[#EFF6FF] px-5 py-3 rounded-full shadow-sm">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div class="xl:col-span-1 {{ $rtl ? 'xl:order-2' : 'xl:order-3' }}">
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                        ...
                        <div class="bg-gradient-to-{{ $rtl ? 'l' : 'r' }} from-[#DBEAFE] to-[#EFF6FF] p-4 border-b border-gray-100">
                            <div class="flex items-center {{ $rtl ? 'justify-between' : 'justify-between flex-row-reverse' }}">
                                <div class="flex items-center gap-2">
                                    <span class="text-xs text-[#3B82F6] font-medium">{{ __('Secure') }}</span>
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="flex gap-3 mb-4">
                                <button
                                    ...
                                    :class="paymentMethod === 'card' ? 'border-[#3B82F6] bg-[#DBEAFE] text-[#3B82F6]' : 'border-gray-200 hover:border-gray-300'"
                                ...
                                <button
                                    ...
                                    :class="paymentMethod === 'bit' ? 'border-[#3B82F6] bg-[#DBEAFE] text-[#3B82F6]' : 'border-gray-200 hover:border-gray-300'"
                                    class="flex-1 p-3 border-2 rounded-lg transition-colors text-center"
                                >
                            ...
                            <div x-show="paymentMethod === 'card'" x-cloak class="space-y-4">
                                ...
                                <div class="mb-6">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-medium text-[#3B82F6] bg-[#DBEAFE] rounded-full">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <label
                                            ...
                                            :class="selectedToken === '{{ $token->id }}'
                                                ? 'border-[#3B82F6] bg-gradient-to-br from-[#DBEAFE] to-[#EFF6FF] shadow-md'
                                                : 'border-[#E9E9E9] bg-white hover:border-[#3B82F6] hover:shadow-sm'"
                                        >
                                            {{-- Radio Button --}}
                                            <input
                                                type="radio"
                                                ...
                                                class="text-[#3B82F6] focus:ring-[#3B82F6] focus:ring-offset-2 w-5 h-5"
                                            >
                                            ...
                                            <div
                                                ...
                                                x-cloak
                                                class="absolute top-2 {{ $rtl ? 'left-2' : 'right-2' }} w-6 h-6 bg-[#3B82F6] rounded-full flex items-center justify-center shadow-lg"
                                            >
                                        ...
                                        <label
                                            ...
                                            :class="selectedToken === 'new'
                                                ? 'border-[#3B82F6] bg-gradient-to-br from-[#DBEAFE] to-[#EFF6FF] shadow-md'
                                                : 'border-dashed border-[#E9E9E9] bg-white hover:border-[#3B82F6] hover:border-solid hover:shadow-sm'"
                                        >
                                            {{-- Radio Button --}}
                                            <input
                                                type="radio"
                                            ...
                                            <div class="{{ $rtl ? 'mr-4' : 'ml-4' }} flex-1 flex items-center gap-4">
                                                {{-- Plus Icon --}}
                                                <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center group-hover:from-[#DBEAFE] group-hover:to-[#EFF6FF] transition-colors">
                                                    <svg class="w-6 h-6 text-gray-500 group-hover:text-[#3B82F6] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div x-show="selectedToken === 'new'" x-cloak class="space-y-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <input type="checkbox" id="save_card" name="save_card" value="1" x-model="saveCard" class="w-4 h-4 text-[#3B82F6] border-gray-300 rounded focus:ring-[#3B82F6]">
                            ...
                            <div class="flex items-start gap-3 pt-2">
                                <input type="checkbox" id="payment-terms" class="mt-1 w-4 h-4 text-[#3B82F6] border-gray-300 rounded focus:ring-[#3B82F6]" required>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 mt-6">
                        ...
                        <div class="text-center mb-6">
                            ...
                            <div class="space-y-2 text-sm text-[#8890B1]">
                                <p class="flex items-center justify-center gap-2">
                                    <svg class="w-4 h-4 text-[#3B82F6]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                        ...
                        <button
                            ...
                            class="w-full bg-[#3B82F6] hover:bg-[#2563EB] text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/25"
                        >
                        ...
                        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                            ...
                            <div class="bg-gradient-to-{{ $rtl ? 'l' : 'r' }} from-[#F8F9FF] to-white p-4 border-b border-gray-100">
                                <div class="flex items-center gap-3 {{ $rtl ? 'justify-end' : 'justify-start' }}">
                                    ...
                                    <div class="w-8 h-8 bg-[#3B82F6] rounded-lg flex items-center justify-center shadow-sm">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="xl:col-span-1 {{ $rtl ? 'xl:order-1' : 'xl:order-2' }}">
                    <div class="bg-white rounded-2xl shadow-sm p-6 sticky top-8">
                        ...
                        <div class="flex justify-between pt-4 border-t-2 border-gray-200 mt-4">
                            ...
                            <span class="text-lg font-bold text-[#3B82F6]">{{ $currencySymbol }}{{ number_format($amount, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
